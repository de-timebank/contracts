...
namespace ERC20:
    ...
    func total_supply{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}() -> (
        ...
        let (total_supply : felt) = ERC20_total_supply.read()
        return (total_supply)
    end
    ...
    func allowance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (remaining : felt) = ERC20_allowances.read(owner, spender)
        return (remaining)
    end
    ...
    func increase_allowance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (caller) = get_caller_address()
        let (current_allowance) = ERC20_allowances.read(caller, spender)
    ...
    func decrease_allowance{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (caller) = get_caller_address()
        let (current_allowance) = ERC20_allowances.read(owner=caller, spender=spender)
    ...
    func _transfer{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(
        ...
        let (sender_balance) = ERC20_balances.read(account=sender)

        with_attr error_message("ERC20: transfer amount exceeds balance"):
            assert_le_felt(amount, sender_balance)
